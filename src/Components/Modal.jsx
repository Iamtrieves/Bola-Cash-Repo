...
const Modal = ({ isVisible }) => {
  return (
    <div
      className={`w-44 text-center absolute shadow-md border border-[#E9F3E9] z-10 top-16 right-[60%] p-2 rounded-2xl bg-[#E9F3E9] transition-all duration-300 transform ${
