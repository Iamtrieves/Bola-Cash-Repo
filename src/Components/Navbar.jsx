...
const Navbar = () => {
  return (
    <nav className="fixed h-[5rem] w-screen bg-white bg-opacity-90 z-10 lg:py-[0.9375rem] py-[0.9rem] lg:px-[3.5rem] px-[1.3125rem]">
      <div className="flex items-center justify-between">
        <div className="size-10">
          <img className="size-full object-cover" src={BolaCashLogo} alt="" />
        </div>
        <div className="gap-[2.5rem] py-[1rem] px-[0.625rem] lg:flex hidden">
          <NavLink
            to="/"
            exact
            className={({ isActive }) =>
